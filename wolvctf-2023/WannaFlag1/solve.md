# Wanna Flag I: An Introduction

- Category: OSINT
- Difficulty: Easy
- Final Point Value: 188
- Solves: 107
...
The challenge tell you the first step to find the flag: reverse image search. When doing this we find that the image is The Cube at the University of Michigan.

Sorting the reviews by newest, we find the next hint!

![review.png](review.png)

This gives us a the netcat prompt `nc wanna-flag-i.wolvctf.io 1337`
...
This output gives us hints for both [WannaFlag1](./) and [WannaFlag2](../WannaFlag2/solve.md)

For this challenge in particular, we will focus on the ending message about John OSINT. Searching up John OSINT on twitter leads us to his profile page [here](https://twitter.com/JohnOSINT_).

John OSINT gives us the encrypted flag `d2N0Znt1aGhoX3doM3IzX2QxZF80bGxfMHVyX2ZsNGdzX2cwP30=` which when decrypted in base 64 gives use the flag!
